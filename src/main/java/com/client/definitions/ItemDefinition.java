...
public final class ItemDefinition {
	public int rdc = 0;
	public int Recolorhue = 0;
	public int rdc3 = 0;
		public static void applyTexturing(Model model, int id) { //Applies Texture onto item
			switch (id) {
			
			case 22001: //Infernal PHat
	...
	private static void customItems(int itemId) {
		...
		case 22001:
			...
			break;
		case 6832:
			itemDef.name = "Tektus Crate";
			itemDef.description = "It's a Tektus Crate";
			itemDef.inventoryOptions = new String[]{"Open", null, null, null, null};
			break;
		case 22072:
			itemDef.name = "Angel of Death Boots";
			itemDef.modelId = 39501;
			itemDef.modelZoom = 850;
			itemDef.modelRotation2 = 2000;
			itemDef.modelRotation1 = 75;
			itemDef.modelOffset1 = 1;
			itemDef.modelOffset2 = 1;
			itemDef.maleModel = 39501;
			itemDef.femaleModel = 39501;
            //itemDef.anInt164 = -1;
            //itemDef.anInt188 = -1;
            //itemDef.aByte205 = -8;
			itemDef.groundOptions = new String[] { null, null, "Take", null, null };
			...
			itemDef.inventoryOptions[1] = "Wear";
			itemDef.inventoryOptions[2] = null;
			itemDef.description = "Malthael's Boots";
			break;
		case 22073:
			itemDef.name = "Angel of Death Robe";
			itemDef.modelId = 39502;
			itemDef.modelZoom = 850;
			itemDef.modelRotation2 = 2000;
			itemDef.modelRotation1 = 75;
			itemDef.modelOffset1 = 1;
			itemDef.modelOffset2 = 1;
			itemDef.maleModel = 39503;
			itemDef.femaleModel = 39503;
            //itemDef.anInt164 = -1;
            //itemDef.anInt188 = -1;
            //itemDef.aByte205 = -8;
			itemDef.groundOptions = new String[] { null, null, "Take", null, null };
			...
			itemDef.inventoryOptions[1] = "Wear";
			itemDef.inventoryOptions[2] = null;
			itemDef.description = "Malthael's Robe";
			break;
		case 22074:
			itemDef.name = "Angel of Death Gloves";
			itemDef.modelId = 39504;
			itemDef.modelZoom = 850;
			itemDef.modelRotation2 = 2000;
			itemDef.modelRotation1 = 75;
			itemDef.modelOffset1 = 1;
			itemDef.modelOffset2 = 1;
			itemDef.maleModel = 39505;
			itemDef.femaleModel = 39505;
            //itemDef.anInt164 = -1;
            //itemDef.anInt188 = -1;
            //itemDef.aByte205 = -8;
			itemDef.groundOptions = new String[] { null, null, "Take", null, null };
			...
			itemDef.inventoryOptions[1] = "Wear";
			itemDef.inventoryOptions[2] = null;
			itemDef.description = "Malthael's Gloves";
			break;
		case 22075:
			itemDef.name = "Angel of Death Helmet";
			itemDef.modelId = 39506;
			itemDef.modelZoom = 850;
			itemDef.modelRotation2 = 2000;
			itemDef.modelRotation1 = 75;
			itemDef.modelOffset1 = 1;
			itemDef.modelOffset2 = 1;
			itemDef.maleModel = 39507;
			itemDef.femaleModel = 39507;
            //itemDef.anInt164 = -1;
            //itemDef.anInt188 = -1;
            //itemDef.aByte205 = -8;
			itemDef.groundOptions = new String[] { null, null, "Take", null, null };
			...
			itemDef.inventoryOptions[1] = "Wear";
			itemDef.inventoryOptions[2] = null;
			itemDef.description = "Malthael's Helmet";
			break;
		case 22076:
			itemDef.name = "Angel of Death Body";
			...
			itemDef.modelOffset1 = 1;
			itemDef.modelOffset2 = 1;
			itemDef.maleModel = 39509;
			itemDef.femaleModel = 39509;
            //itemDef.anInt164 = -1;
            //itemDef.anInt188 = -1;
            //itemDef.aByte205 = -8;
			itemDef.groundOptions = new String[] { null, null, "Take", null, null };
			...
			itemDef.inventoryOptions[1] = "Wear";
			itemDef.inventoryOptions[2] = null;
			itemDef.description = "Malthael's Body";
			break;
		case 22077:
			itemDef.name = "Angel of Death Defender";
			...
			itemDef.modelOffset1 = 1;
			itemDef.modelOffset2 = 1;
			itemDef.maleModel = 39511;
			itemDef.femaleModel = 39511;
            //itemDef.anInt164 = -1;
            //itemDef.anInt188 = -1;
            //itemDef.aByte205 = -8;
			itemDef.groundOptions = new String[] { null, null, "Take", null, null };
			...
			itemDef.inventoryOptions[1] = "Wear";
			itemDef.inventoryOptions[2] = null;
			itemDef.description = "Malthael's Right Sickle";
			break;
		case 22078:
			itemDef.name = "Angel of Death Sickle";
			itemDef.modelId = 39512;
			itemDef.modelZoom = 850;
			itemDef.modelRotation2 = 2000;
			itemDef.modelRotation1 = 75;
			itemDef.modelOffset1 = 1;
			itemDef.modelOffset2 = 1;
			itemDef.maleModel = 39513;
			itemDef.femaleModel = 39513;
            //itemDef.anInt164 = -1;
            //itemDef.anInt188 = -1;
            //itemDef.aByte205 = -8;
			itemDef.groundOptions = new String[] { null, null, "Take", null, null };
			...
			itemDef.inventoryOptions[1] = "Wear";
			itemDef.inventoryOptions[2] = null;
			itemDef.description = "Malthael's Left Sickle";
			break;
		case 22079:
			itemDef.name = "Angel of Death 2h Sickles";
			itemDef.modelId = 39514;
			itemDef.modelZoom = 850;
			itemDef.modelRotation2 = 2000;
			itemDef.modelRotation1 = 75;
			itemDef.modelOffset1 = 1;
			itemDef.modelOffset2 = 1;
			itemDef.maleModel = 39515;
			itemDef.femaleModel = 39515;
            //itemDef.anInt164 = -1;
            //itemDef.anInt188 = -1;
            //itemDef.aByte205 = -8;
			itemDef.groundOptions = new String[] { null, null, "Take", null, null };
			...
			itemDef.inventoryOptions[1] = "Wear";
			itemDef.inventoryOptions[2] = null;
			itemDef.description = "Malthael's Sickles";
			break;
		case 22080:
			itemDef.name = "Cryptic Sword";
			itemDef.modelId = 39526;
			itemDef.modelZoom = 440;
			itemDef.modelRotation2 = 1852;
			itemDef.modelRotation1 = 76;
			itemDef.modelOffset1 = 1;
			itemDef.modelOffset2 = 1;
			itemDef.maleModel = 39526;
			itemDef.femaleModel = 39526;
            //itemDef.anInt164 = -1;
            //itemDef.anInt188 = -1;
            //itemDef.aByte205 = -8;
			itemDef.groundOptions = new String[] { null, null, "Take", null, null };
			...
			itemDef.inventoryOptions[1] = "Wear";
			itemDef.inventoryOptions[2] = null;
			itemDef.description = "Cryptic Tried Something";
			break;
		case 22083:
			itemDef.name = "Boots of Tektus";
			itemDef.modelId = 39520;
			itemDef.modelZoom = 850;
			itemDef.modelRotation2 = 2000;
			itemDef.modelRotation1 = 75;
			itemDef.modelOffset1 = 1;
			itemDef.modelOffset2 = 1;
			itemDef.maleModel = 39520;
			itemDef.femaleModel = 39520;
            //itemDef.anInt164 = -1;
            //itemDef.anInt188 = -1;
            //itemDef.aByte205 = -8;
			itemDef.groundOptions = new String[] { null, null, "Take", null, null };
			...
			break;
		case 22084:
			itemDef.name = "Legplates of Tektus";
			itemDef.modelId = 39522;
			itemDef.modelZoom = 1050;
			itemDef.modelRotation2 = 2000;
			itemDef.modelRotation1 = 75;
			itemDef.modelOffset1 = 1;
			itemDef.modelOffset2 = 1;
			itemDef.maleModel = 39522;
			itemDef.femaleModel = 39522;
            //itemDef.anInt164 = -1;
            //itemDef.anInt188 = -1;
            //itemDef.aByte205 = -8;
			itemDef.groundOptions = new String[] { null, null, "Take", null, null };
			...
			break;
		case 22081:
			itemDef.name = "Helm of Tektus";
			itemDef.modelId = 39518;
			itemDef.modelZoom = 850;
			itemDef.modelRotation2 = 2000;
			itemDef.modelRotation1 = 75;
			itemDef.modelOffset1 = 1;
			itemDef.modelOffset2 = 1;
			itemDef.maleModel = 39518;
			itemDef.femaleModel = 39518;
            //itemDef.anInt164 = -1;
            //itemDef.anInt188 = -1;
            //itemDef.aByte205 = -8;
			itemDef.groundOptions = new String[] { null, null, "Take", null, null };
			...
			itemDef.inventoryOptions[1] = "Wear";
			itemDef.inventoryOptions[2] = null;
			itemDef.description = "Tektus's Helmet";
			break;
		case 22082:
			itemDef.name = "Chestplate of Tektus";
			itemDef.modelId = 39524;
			itemDef.modelZoom = 850;
			itemDef.modelRotation2 = 2000;
			itemDef.modelRotation1 = 75;
			itemDef.modelOffset1 = 1;
			itemDef.modelOffset2 = 1;
			itemDef.maleModel = 39524;
			itemDef.femaleModel = 39524;
            //itemDef.anInt164 = -1;
            //itemDef.anInt188 = -1;
            //itemDef.aByte205 = -8;
			itemDef.groundOptions = new String[] { null, null, "Take", null, null };
			...
			itemDef.inventoryOptions[1] = "Wear";
			itemDef.inventoryOptions[2] = null;
			itemDef.description = "Tektus's Body";
			break;
		}
	}
	 ...
	 * stream.readShort(); else if(opcode == 2) name = stream.readString();
	 * else if(opcode == 3) description = stream.readString(); else if(opcode == 4)
	 * modelZoom = stream.readShort(); else if(opcode == 5) modelRotation1 =
	 * stream.readShort(); else if(opcode == 6) modelRotation2 =
	 * stream.readShort(); else if(opcode == 7) { modelOffset1 =
	 * stream.readShort(); if(modelOffset1 > 32767) modelOffset1 -= 0x10000;
	 * } else if(opcode == 8) { modelOffset2 = stream.readShort();
	 ...
	 * stream.readShort(); aByte205 = stream.readSignedByte(); } else if
	 * (opcode == 24) anInt188 = stream.readShort(); else if (opcode == 25) {
	 * femaleModel = stream.readShort(); aByte154 = stream.readSignedByte();
	 * } else if (opcode == 26) anInt164 = stream.readShort(); else if(opcode
	 ...
	 * index++) { originalModelColors[index] = stream.readShort();
	 * modifiedModelColors[index] = stream.readShort(); } } else if(opcode ==
	 ...
	 * stream.readShort(); modifiedTextureColors[index] = (short)
	 * stream.readShort(); } } else if(opcode == 65) { searchableItem = true;
	 * } else if(opcode == 78) anInt185 = stream.readShort(); else if(opcode
	 * == 79) anInt162 = stream.readShort(); else if(opcode == 90) anInt175 =
	 * stream.readShort(); else if(opcode == 91) anInt197 =
	 * stream.readShort(); else if(opcode == 92) anInt166 =
	 * stream.readShort(); else if(opcode == 93) anInt173 =
	 * stream.readShort(); else if(opcode == 95) anInt204 =
	 * stream.readShort(); else if(opcode == 97) certID =
	 * stream.readShort(); else if(opcode == 98) certTemplateID =
	 * stream.readShort(); else if (opcode >= 100 && opcode < 110) { if
	 * (stackIDs == null) { stackIDs = new int[10]; stackAmounts = new int[10]; }
	 * stackIDs[opcode - 100] = stream.readShort(); stackAmounts[opcode -
	 * 100] = stream.readShort(); } else if(opcode == 110) anInt167 =
	 * stream.readShort(); else if(opcode == 111) anInt192 =
	 * stream.readShort(); else if(opcode == 112) anInt191 =
	 * stream.readShort(); else if(opcode == 113) anInt196 =
	 ...
	 * stream.readShort(); else if (opcode == 140) opcode140 =
	 * stream.readShort(); else if (opcode == 148) opcode148 =
	 * stream.readShort(); else if (opcode == 149) opcode149 =
	 * stream.readShort(); else { System.out.println("Error loading item " +
	 * id + ", opcode " + opcode); } } }
	 */
	...
	private void readValues(Stream stream) {
		while (true) {
			...
			/*} else if (opcode == 42) {
				...
				opcode139 = stream.readUnsignedShort();
			} else if (opcode == 140) {
				opcode140 = stream.readUnsignedShort();
			} else if (opcode == 148) {
				opcode148 = stream.readUnsignedShort();
			} else if (opcode == 149) {
				opcode149 = stream.readUnsignedShort();
			} else {
	...
	public static Sprite getSprite(int itemId, int itemAmount, int highlightColor) {
		ItemDefinition itemDef = forID(itemId);
		if (highlightColor == 0 && !itemDef.animateInventory()) {
		...
		/*if (highlightColor == 0 && !ItemDefinition.animateInventory) {
			clas(sprite2, itemId); class
		}*/
		if (highlightColor == 0 && !itemDef.animateInventory()) {
