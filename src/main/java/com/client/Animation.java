...
public final class Animation {
	...
	public static void method528() {
	 	animationlist = new Animation[4500][0];
	}

	public static void load(int file, byte[] fileData){
		try {
			Stream stream = new Stream(fileData);
            Skeleton class18 = new Skeleton(stream);
			int k1 = stream.readUnsignedShort();
			animationlist[file] = new Animation[(int)(k1*3)];
			int ai[] = new int[500];
			int ai1[] = new int[500];
			int ai2[] = new int[500];
			int ai3[] = new int[500];
			for(int l1 = 0; l1 < k1; l1++) {
				...
				Animation class36 = animationlist[file][i2] = new Animation();
	...
	public static Animation forId(int i) {
		try {
			String s = "";
			int file = 0;
			int k = 0;
