...
public class Model extends Renderable {
    ...
    public void read525Model(byte abyte0[], int modelID) {
		 ...
		 * triangleColours2[i12] = nc1.readShort(); if(l1 == 1){
		 ...
		 * (short)(nc6.readShort() - 1); if(x != null) if(D[i12] != -1)
    ...
    public void method470(int i) {
        ...
        Animation class36 = Animation.forId(i);
        if (class36 == null) {
            return;
        }
        Skeleton class18 = class36.aClass18_637;
        anInt1681 = 0;
        anInt1682 = 0;
        anInt1683 = 0;
    ...
    public void method471(int ai[], int j, int k) {
        ...
        Animation class36 = Animation.forId(k);
        if (class36 == null) {
            return;
        }
        Animation class36_1 = Animation.forId(j);
        if (class36_1 == null) {
            method470(k);
            return;
        }
    ...
    public final void renderAtPoint(int i, int j, int k, int l, int i1, int j1, int k1, int l1, long i2) {
        ...
        if (i2 > 0 && aBoolean1684) {
            ...
            if (i6 > k3 && i6 < l3 && k6 > i5 && k6 < k4) {
                if (aBoolean1659) {
                    hoveredModelUID[objectsRendered++] = i2;
                } else {
                    flag1 = true;
                }
            }
            ...
            if (face_render_type == null || face_render_type[k] != -1) {
                ...
                if (flag && (i3 == -5000 || l3 == -5000 || k4 == -5000)) {
                    ...
                    if (flag1
                        ...
                        hoveredModelUID[objectsRendered++] = i22;
                        flag1 = false;
                    }
                    if ((i3 - l3)
    ...
    public static long[] hoveredModelUID = new long[15000];
