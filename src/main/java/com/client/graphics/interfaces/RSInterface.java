...
import com.client.ColorConstants;
...
public class RSInterface {
	...
	public static void addToItemGroup(int id, int w, int h, int x, int y, boolean hasActions, String[] actions) {
		...
		rsi.usableItemInterface = rsi.id == 57171 || rsi.id == 57181 ? true : false;
	 ...
	 */
		...
		//this line renames rsinter = main
			//aswell as adding the interface 57120 ingame
			//now you can do ::interface 57120 and pop up "dailyrewards
		RSInterface main = addInterface(57210);
		
		//main sprite for it
		//addsprite(INTERFACEID, FRAMEID, SPRITE)
		addSprite(57211, 1, "Interfaces/DailyRewards1/SPRITE");
		
		//addSpriteLoader(57211, 1079);
		
		
		//addsprite(INTERFACEID, FRAMEID, SPRITE)
		addSprite(57212, 2, "Interfaces/DailyRewards1/SPRITE");
		addSprite(57213, 2, "Interfaces/DailyRewards1/SPRITE");
		addSprite(57214, 2, "Interfaces/DailyRewards1/SPRITE");
		addSprite(57215, 2, "Interfaces/DailyRewards1/SPRITE");
		addSprite(57216, 2, "Interfaces/DailyRewards1/SPRITE");
		addSprite(57217, 2, "Interfaces/DailyRewards1/SPRITE");
		//addsprite(INTERFACEID, FRAMEID, SPRITE)
		addSprite(57219, 3, "Interfaces/DailyRewards1/SPRITE");
		...
		//text(intefacenumber, "hover", color, ?, ? , 52, (textdrawareas), 0) 
		//the last bit from false - 0 will probably be the same on every line 
		
		addText(57238, "Login", ColorConstants.ORANGE, false, true, 52, tda, 0);
		//config button, interface id, parent id, sprite1, sprite2 (when clicked), width, height, ?, 1, 0, CONFIG ID
		//the config id is making the button work client sided (remember 1810)
		addConfigButton(57239, 57210, 4, 5, 119, 21, "", 1, 0, 1810, "Interfaces/DailyRewards1/SPRITE");
		addText(57240, "Vote", ColorConstants.ORANGE, false, true, 52, tda, 0);
		addConfigButton(57241, 57210, 4, 5, 119, 21, "", 1, 0, 1811, "Interfaces/DailyRewards1/SPRITE");
		
		addText(57242, "Login", ColorConstants.ORANGE, false, true, 52, tda, 0);
		addConfigButton(57243, 57210, 4, 5, 119, 21, "", 1, 0, 1812, "Interfaces/DailyRewards1/SPRITE");
		addText(57244, "Vote", ColorConstants.ORANGE, false, true, 52, tda, 0);
		addConfigButton(57245, 57210, 4, 5, 119, 21, "", 1, 0, 1813, "Interfaces/DailyRewards1/SPRITE");
		
		addText(57246, "Login", ColorConstants.ORANGE, false, true, 52, tda, 0);
		addConfigButton(57247, 57210, 4, 5, 119, 21, "", 1, 0, 1814, "Interfaces/DailyRewards1/SPRITE");
		addText(57248, "Vote", ColorConstants.ORANGE, false, true, 52, tda, 0);
		addConfigButton(57249, 57210, 4, 5, 119, 21, "", 1, 0, 1815, "Interfaces/DailyRewards1/SPRITE");
		
		addText(57250, "Login", ColorConstants.ORANGE, false, true, 52, tda, 0);
		addConfigButton(57251, 57210, 4, 5, 119, 21, "", 1, 0, 1816, "Interfaces/DailyRewards1/SPRITE");
		addText(57252, "Vote", ColorConstants.ORANGE, false, true, 52, tda, 0);
		addConfigButton(57253, 57210, 4, 5, 119, 21, "", 1, 0, 1817, "Interfaces/DailyRewards1/SPRITE");
		
		addText(57254, "Login", ColorConstants.ORANGE, false, true, 52, tda, 0);
		addConfigButton(57255, 57210, 4, 5, 119, 21, "", 1, 0, 1818, "Interfaces/DailyRewards1/SPRITE");
		addText(57256, "Vote", ColorConstants.ORANGE, false, true, 52, tda, 0);
		addConfigButton(57257, 57210, 4, 5, 119, 21, "", 1, 0, 1819, "Interfaces/DailyRewards1/SPRITE");
		
		addText(57258, "Login", ColorConstants.ORANGE, false, true, 52, tda, 0);
		addConfigButton(57259, 57210, 4, 5, 119, 21, "", 1, 0, 1820, "Interfaces/DailyRewards1/SPRITE");
		addText(57260, "Vote", ColorConstants.ORANGE, false, true, 52, tda, 0);
		addConfigButton(57261, 57210, 4, 5, 119, 21, "", 1, 0, 1821, "Interfaces/DailyRewards1/SPRITE");
		
		addHoverText(57262, "Claim Day 7", "Claim", tda, 0, ColorConstants.GREEN, false, true, 100, 14);
		
		
		//main = rsinterface
		//total childeren is allowing (52) ids to be availble to be used
		//if you have say 52 ids and your (totalchildren) says (30) 
		//you will get arrayoutofbounds error when loading client
		//so the total children basically allows 52 ids to be present and used
		main.totalChildren(52);
		//now
		//each child()
		//reverts back to the interface ids above
		//child(frameid, interface id, locationX, locationsY) 
		//the locations are the location on the interface
		//i.e
		//this one below
		//addSprite(57211, 1, "Interfaces/DailyRewards1/SPRITE");
		//this is where 57211 will be places on the interface
		main.child(0, 57211, 10, 10);
		//as well for the others
		//you will need to add a ::data command for your client
		//to see where your cursor is and showing X and Y values
		//to be able to set your own interfaces
		
		
		//each interface above, add text, add hover text, config buttons, hover buttons, all need
		//child ids and location, the child shows it on the interface
		//no child = no placement = no showing
		
		//lets say you add a button client sided and its not a config button
		//server sided u will add the button in buttonpacketwhatever.java
		//and will get the button you need from the interface id here
		//i.e.
		//the 57212(just example) say thats a button, you hover it on client and see the client
		//say 57212(while debugging, showing the buttons etc) u can add it server sided to make it work
...
public static void statsComparatorInterface(TextDrawingArea[] tda) {
	...
	addSprite(53501, 0, "Interfaces/StatsComperator/SPRITE");
	//addSpriteLoader(53501, 1053);
	//	public static void addClickableSprite(int id, String tooltip, String path, int spriteId) {
	addClickableSprite(53502, "Compare Stats", "Interfaces/StatsComperator/SPRITE", 1);
	...
	addClickableSprite(53490, "Close Interface", "Interfaces/StatsComperator/SPRITE", 2);
	...
	addClickableSprite(53508, "Search Items", "Interfaces/StatsComperator/SPRITE", 3);
	//addButtonWSpriteLoader(53508, 931, "Search Items");
	addClickableSprite(54002, "Reset Items", "Interfaces/StatsComperator/SPRITE", 1);
...
public static void addClickableSprite(int id, String tooltip, String path, int spriteId) {
	...
	public static void achievementPopup2(TextDrawingArea[] tda) {
	 ...
	 public static void infoTab(TextDrawingArea[] tda) {
	        ...
	        addHoverText(10232, "@or1@View Achievements", "View Achievements", tda, 0, 1022259, false, true, 150);
    ...
    public static void questTab(TextDrawingArea[] tda) {
		...
		addText(10221, "@gre@Averon-Panel", tda, 2, 16750899, false, true);
		addText(10222, "@gre@averon-rsps.com", tda, 2, 16750899, true, true);
		...
		addText(10406, "@blu@Server information", tda, 2, 16750899, false, true);
		addHoverText(10407, "@cr11@@red@ Players online : @gre@0", "View Details", tda, 0, 1022259, false, true, 150);
		addHoverText(10408, "@cr22@@red@ Wilderness count: @gre@0", "View Details", tda, 0, 1022259, false, true, 150);
		addHoverText(10409, "@cr19@@red@Current event : @red@None", "View Details", tda, 0, 1022259, false, true, 150);
		addHoverText(10410, "@cr18@@red@WOGW: @red@None ", "View Details", tda, 0, 1022259, false, true, 150);
		addHoverText(10411, "@cr9@@red@ Current deal: @red@None", "View Details", tda, 0, 1022259, false, true, 150);
		addText(10412, "@blu@Player information", tda, 2, 16750899, false, true);
